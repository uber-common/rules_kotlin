 ...
 * build wires the full output jar via {@code -XDkaptishSelfjar=<jarPath>}. Only outer classes are
 * injected; processors reach nested types (e.g. a Kotlin {@code companion object}) via enclosed
 * elements.
 */
public class KotlinClassInjectorPlugin implements Plugin {
  ...
  public void init(JavacTask task, String... args) {
    ...
    // The build passes the module's full compiled-Kotlin jar via -XDkaptishSelfjar=<path>.
